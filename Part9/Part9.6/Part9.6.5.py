...
# 1 до 60 (включительно). Перед началом похудения у Гвидо был вес
...
# на текущий день # Также программа должна вывести информацию о номере дня похудения,
...
print(f'# {day} day: current weight = {weight} kg, weight goal = {100 - day * 0.2} kg')
